...
class Stock_in(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        try:
            ...
            operation_record = {"asset_id": req_data['asset_id_field'], "type": "0", 'before_field': before_field, "after_field": after_field,'operator': request.user}
...
class Batch_stock_in(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        for i in range(1,row):
            ...
            # OperationLogs表中after_field
            after_field = operator_record.get_after_field(asset_dict['asset_id'])
            operation_record = {"asset_id": asset_dict['asset_id'], "type": "0", 'before_field': before_field,"after_field": after_field, 'operator': request.user}
            OperationLogs.objects.create(**operation_record)
